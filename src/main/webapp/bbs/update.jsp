...
<div class="form-background">
        ...
        <div class="form-white">
            <form id="updateForm" name="writeForm" method="post" action="write_process.jsp" enctype="multipart/form-data">
                <div class="w-100">
                ...
                <h3>수정하기</h3>
                <p>제목</p>
                <input class="form-input" type="text" id="title" name="title" value="${board.title}">
                <p>이메일</p>
                ...
                <div class="w-100">
                    <p>내용</p>
                    <textarea class="form-input form-textarea" id="content" name="content" cols="50" rows="20" >${board.content}</textarea>
                </div>
                <div class="w-100">
                	<p>첨부파일: ${board.originfile_name}</p>
