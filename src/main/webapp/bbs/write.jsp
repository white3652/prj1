...
<div class="form-background">
        ...
        <div class="form-white">
            <form id="writeForm" name="writeForm" method="post" action="write_process.jsp" enctype="multipart/form-data">
                <div class="w-100">
                ...
                <div class="button-container">
                    ...
                    <button class="button" id="cancelButton" onclick="location.href='list.jsp'">취소</button>
                </div>
            </form>
        </div>
    </div>
